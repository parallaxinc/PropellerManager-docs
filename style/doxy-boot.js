$( document ).ready(function() {
    ...
    $('li > a[href="namespaces.html"] > span').before("<i class='glyphicon glyphicon-align-justify'></i> ");
    $('li > a[href="annotated.html"] > span').before("<i class='glyphicon glyphicon-list'></i> ");
    $('li > a[href="classes.html"] > span').before("<i class='glyphicon glyphicon-book'></i> ");
    $('li > a[href="inherits.html"] > span').before("<i class='glyphicon glyphicon-map-marker'></i> ");
    $('li > a[href="functions.html"] > span').before("<i class='glyphicon glyphicon-list'></i> ");
    $('li > a[href="functions_func.html"] > span').before("<i class='glyphicon glyphicon-list'></i> ");
